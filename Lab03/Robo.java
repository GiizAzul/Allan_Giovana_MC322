...
public class Robo {
    ...
    private ArrayList<Sensor> listaSensores; // lista de sensores do robo

    // Acessível somente para subclasses
    protected boolean visivel = true;

    public Robo(String nome, String direcao, int posicaoX, int posicaoY) { // constructor q inicializa nome e posição do
                                                                           // robo
        this.nome = nome;
